...
public class KakaoInfoExample extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kakao_info_example);
    }
    ...
    public void info(View v){
        UserManagement.requestMe(new MeResponseCallback() {
            ...
            public void onSessionClosed(ErrorResult errorResult) {
                startActivity(new Intent(KakaoInfoExample.this, LoginActivity.class));
                finish();
            }
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                UserManagement.requestUnlink(new UnLinkResponseCallback() {
                                    ...
                                    @Override
                                    public void onNotSignedUp() {
                                        startActivity(new Intent(KakaoInfoExample.this, KakaoSignupActivity.class));
                                        finish();
                                    }
